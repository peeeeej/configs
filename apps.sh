...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.74/Rectangle0.74.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.74.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.74')
...
cp -R /Volumes/Rectangle0.74/Rectangle.app /Applications
