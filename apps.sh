...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.81.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.81')
...
cp -R /Volumes/Rectangle0.81/Rectangle.app /Applications
