...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.73/Rectangle0.73.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.73.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.73')
...
cp -R /Volumes/Rectangle0.73/Rectangle.app /Applications
