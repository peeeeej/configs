...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.64/Rectangle0.64.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.64.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.64')
...
cp -R /Volumes/Rectangle0.64/Rectangle.app /Applications
