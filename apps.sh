...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.76/Rectangle0.76.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.76.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.76')
...
cp -R /Volumes/Rectangle0.76/Rectangle.app /Applications
