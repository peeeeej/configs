...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.66/Rectangle0.66.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.66.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.66')
...
cp -R /Volumes/Rectangle0.66/Rectangle.app /Applications
