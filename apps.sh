...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.86/Rectangle0.86.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.86.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.86')
...
cp -R /Volumes/Rectangle0.86/Rectangle.app /Applications
