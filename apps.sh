...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.75/Rectangle0.75.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.75.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.75')
...
cp -R /Volumes/Rectangle0.75/Rectangle.app /Applications
