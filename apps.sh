...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.60/Rectangle0.60.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.60.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.60')
...
cp -R /Volumes/Rectangle0.60/Rectangle.app /Applications
