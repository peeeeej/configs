...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.79/Rectangle0.79.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.79.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.79')
...
cp -R /Volumes/Rectangle0.79/Rectangle.app /Applications
