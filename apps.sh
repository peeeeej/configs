...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.89/Rectangle0.89.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.89.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.89')
...
cp -R /Volumes/Rectangle0.89/Rectangle.app /Applications
