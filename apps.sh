...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.80/Rectangle0.80.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.80.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.80')
...
cp -R /Volumes/Rectangle0.80/Rectangle.app /Applications
