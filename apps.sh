...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.65/Rectangle0.65.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.65.dmg')
...
cp -R /Volumes/Rectangle0.65/Rectangle.app /Applications
