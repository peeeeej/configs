...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.63/Rectangle0.63.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.63.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.63')
...
cp -R /Volumes/Rectangle0.63/Rectangle.app /Applications
