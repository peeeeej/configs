...
# rectangle
curl -O -L https://github.com/rxhanson/Rectangle/releases/download/v0.56/Rectangle0.56.dmg
...
declare -a dmgs=('googlechrome.dmg' 'Slack.dmg' 'Rectangle0.56.dmg')

declare -a volumes=('Google Chrome' 'Slack' 'Rectangle0.56')
...
cp -R /Volumes/Rectangle0.56/Rectangle.app /Applications
